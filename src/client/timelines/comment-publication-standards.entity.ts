...
@Entity()
export class CommentPublicationStandardsEntity extends BaseEntity {
...
/* ALL MANY TO ONE JOIN */
  ...
  // for publication
  @ManyToOne(() => PublicationsEntity, (publication) => publication.commentPublications)
	@JoinColumn({ name: 'publication_id' })
  publication: PublicationsEntity;

  // for publication
  @ManyToOne(() => UsersEntity, (user) => user.commentUser)
